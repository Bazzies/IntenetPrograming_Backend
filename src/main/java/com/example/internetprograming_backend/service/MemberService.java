...
public class MemberService {
    ...
    @Transactional
    public void requestRoleChange(CustomMemberPrincipal customMemberPrincipal, TokenRole tokenRole) {
        Member member = memberRepository.findById(customMemberPrincipal.getMemberId())
                .orElseThrow(() -> new CustomException(CustomExceptionResponse.NOT_FOUND_MEMBER));
        ...
        } else if (tokenRole.equals(TokenRole.ADMIN)) {
            throw new CustomException(CustomExceptionResponse.CANNOT_CHANGE_TO_ADMIN_ROLE);
        } else if (currentMemberRole.equals(tokenRole)) {
        ...
        EmailMessage emailMessage = EmailMessage.builder()
                ...
                .message("권한 변경 요청" +
                        ...
                        "\n변경 요청 권한 : " + tokenRole.getTokenRoleName()
                )
                .build();
